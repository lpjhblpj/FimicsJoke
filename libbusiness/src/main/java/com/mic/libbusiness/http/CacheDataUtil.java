...
import com.mic.libcore.utils.MD5Util;
...
public class CacheDataUtil {
    ...
    public static String getCacheResultJson(String finalUrl) {
        ...
        final DaoSupport<CacheData> dataDaoSupport = DaoSupportFactory.getInstance().getDao(CacheData.class);
    ...
    public static long cacheData(String finalUrl, String resultJson) {
        final DaoSupport<CacheData> dataDaoSupport = DaoSupportFactory.getInstance().
                getDao(CacheData.class);
        dataDaoSupport.delete("mUrlKey=?", new String[]{MD5Util.string2MD5(finalUrl)});
